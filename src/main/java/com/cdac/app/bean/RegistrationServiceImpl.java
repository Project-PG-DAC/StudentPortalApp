...
public class RegistrationServiceImpl implements IRegistrationService {
	...
	private static Long prnDAC = 230340120001L;
	private static Long prnDBDA = 230340130001L;
	private static Long prnDESD = 230340140001L;
	...
	public void sendRegisterationEmail(Long userId) {
		...
		if(user!=null) {
			...
			email.setSubject("IACSD PUNE | "
							+ "Registration Success | "
							+ name);

			String messageBody = "Hi "+name+"\n"
							   +"Greetings of the day!\n"
							   +"Welcome to IACSD Pune.\n"
							   +"\n"
							   +"\n"
							   +"\n"
